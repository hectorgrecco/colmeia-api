...
describe('User routes', () => {
  describe('POST /v1/auth', () => {
    ...
    test('should return 401 error is access token is missing', async () => {
      await request(app).post('/v1/auth').send(newUser).expect(httpStatus.UNAUTHORIZED);
    });
  ...
  describe('GET /v1/auth', () => {
    ...
    test('should return 401 if access token is missing', async () => {
      ...
      await request(app).get('/v1/auth').send().expect(httpStatus.UNAUTHORIZED);
    });

    test('should return 403 if a non-admin is trying to access all auth', async () => {
      await insertUsers([userOne, userTwo, admin]);
  ...
  describe('DELETE /v1/auth/:userId', () => {
